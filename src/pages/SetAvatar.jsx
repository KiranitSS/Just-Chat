...
function SetAvatar() {
    const avatarsKey = "?apikey=eCtnq7oL6k10gA";
    ...
    const setProfilePicture = async () => {
        if (selectedAvatar === undefined) {
            ...
            const user = await JSON.parse(localStorage.getItem("just-chat-user")); 
            ...
            if(data.isSet){
                ...
                localStorage.setItem("just-chat-user", JSON.stringify(user));
                navigate("/");
            }else {
